...
const String tProfileHeading = "Benson Muchoki";
const String tProfileSubHeading = "muchokibenson60@gmail.com";
const String tEditProfile = "Edit Profile";
const String tMenu1 = "Statements and Reports";
const String tMenu2 = "Settings";
const String tMenu3 = "Help";
const String tMenu4 = "Privacy & Security";
const String tMenu5 = "Logout";
const String tMemberNo1 = "Membership Number";
const String tMemberNo2 = "KSDA - 001";


// -- Splash Screen Text
const String tAppTitle = "KARENGATA";
const String tAppTagline = "Empowered to Serve";
...
const String tLoginSubTitle = "Empowered to Serve";
